...
export const plans = [
  { id: "twice-anchor", name: "TWICE North America Anchor Route", artist: "TWICE", status: "Draft", stops: 6, capacity: "18K avg", cities: ["Los Angeles", "New York", "Chicago", "Dallas", "Atlanta", "Seattle"] },
  { id: "twice-west", name: "TWICE West Coast Demand Sweep", artist: "TWICE", status: "Planned", stops: 4, capacity: "20K avg", cities: ["Los Angeles", "San Francisco", "Seattle", "Phoenix"] }
];
